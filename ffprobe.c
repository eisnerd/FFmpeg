...
static void json_print_no_int(WriterContext *wctx, const char *key, long long int value)
{
    wctx->nb_item--;
}
...
static const Writer json_brief_writer = {
    .name         = "json-brief",
    .priv_size    = sizeof(JSONContext),
...
#include "cmdutils_common_opts.h"
    ...
    { "print_format", OPT_STRING | HAS_ARG, {(void*)&print_format},
      "set the output printing format (available formats are: default, compact, csv, json, json-brief)", "format" },
